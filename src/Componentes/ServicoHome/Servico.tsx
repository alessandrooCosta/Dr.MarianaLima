  ...
  return (
    <section className="servicos">
      ...
      <div className="card-servico">
        ...
        <div className="card">
          <i><img src="\imagens\icones\exame.svg"></img></i>
